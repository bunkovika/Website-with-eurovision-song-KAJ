...
export const rewriteSvgNext = (setSvgNextPath, setSvgNextFill) => {
    ...
    svg.insertBefore(rect, svg.firstChild);
    svg.setAttribute('d', "M22.551 35.0204C22.2857 35.0204 22.0204 34.9143 21.8082 34.702C21.3837 34.2775 21.3837 33.6143 21.8082 33.1898L29.7674 25.2306C30.1918 24.8061 30.8551 24.8061 31.2796 25.2306C31.7041 25.6551 31.7041 26.3184 31.2796 26.7428L23.3204 34.702C23.0816 34.9143 22.8163 35.0204 22.551 35.0204Z\n" +
    ...
    setSvgNextPath(svg.getAttribute("d"));
    svg.setAttribute("fill", "#613A6B");
    setSvgNextFill(svg.getAttribute("fill"));
...
export const resetSvgNext = (setSvgNextPath, setSvgNextFill) => {
    ...
    svg.setAttribute('d', "M26.0204 40.4081C25.7143 40.4081 25.4081 40.2857 25.1632 40.0408C24.6734 39.551 24.6734 38.7857 25.1632 38.2959L34.3469 29.1122C34.8367 28.6224 35.602 28.6224 36.0918 29.1122C36.5816 29.602 36.5816 30.3673 36.0918 30.8571L26.9081 40.0408C26.6326 40.2857 26.3265 40.4081 26.0204 40.4081Z M35.2041 31.2245C34.8979 31.2245 34.5918 31.102 34.3469 30.8571L25.1632 21.6735C24.6734 21.1837 24.6734 20.4184 25.1632 19.9286C25.653 19.4388 26.4183 19.4388 26.9081 19.9286L36.0918 29.1122C36.5816 29.602 36.5816 30.3673 36.0918 30.8571C35.8163 31.102 35.5102 31.2245 35.2041 31.2245Z M30 54.4898C16.5 54.4898 5.51019 43.5 5.51019 30C5.51019 16.5 16.5 5.51019 30 5.51019C43.5 5.51019 54.4898 16.5 54.4898 30C54.4898 43.5 43.5 54.4898 30 54.4898ZM30 7.95917C17.8469 7.95917 7.95917 17.8469 7.95917 30C7.95917 42.153 17.8469 52.0408 30 52.0408C42.153 52.0408 52.0408 42.153 52.0408 30C52.0408 17.8469 42.153 7.95917 30 7.95917Z");
